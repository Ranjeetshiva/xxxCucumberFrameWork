...
import com.iportman.automation.allModules.adminstration.windows.AttachmentMasterPage;
import io.cucumber.java.en.Given;
import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;

public class AdminWindowStepDefs {
    ...
    @Then("check for search box")
    public void checkForSearchBox() {
        AttachmentMasterPage attachmentMasterPage = new AttachmentMasterPage();
        attachmentMasterPage.verifySearchBox();
    }
}
